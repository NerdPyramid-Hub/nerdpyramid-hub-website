  ...
  return (
    <section className="min-h-screen bg-[#f3f2e6] py-16 px-4">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="text-center mb-16 mt-16 relative min-h-[280px] flex items-center justify-center">
          <div
            className="absolute inset-0 rounded-3xl bg-cover bg-center bg-no-repeat"
            style={{ backgroundImage: `url('/education coding.jpg')` }}
          />
          <div className="absolute inset-0 bg-gradient-to-br from-[#183B4E]/80 via-[#27548A]/70 to-[#183B4E]/80 rounded-3xl" />

          <div className="relative z-10 py-16 px-6 w-full">
            <div className="flex items-center justify-center gap-4 mb-6">
              <div className="rounded-2xl p-3.5 bg-white/15 backdrop-blur-sm border border-white/20 shadow-xl">
                <BookOpen className="h-9 w-9 text-[#DDA853]" />
              </div>
              <h1 className="text-4xl md:text-6xl font-extrabold text-white">
                Learn With Us
              </h1>
            </div>
            <div className="border-l-4 border-[#DDA853] px-8 py-5 shadow-xl rounded-xl max-w-4xl mx-auto bg-white/95 backdrop-blur-sm">
              <p className="text-lg md:text-xl text-[#27548A] font-semibold">
                Transform your career with our{" "}
                <span className="font-bold text-[#183B4E]">industry-focused</span>{" "}
                learning programs.
            ...
            <div className="max-w-xl w-full bg-[#F3F3E0] rounded-2xl p-8 shadow-2xl border-2 border-[#27548A]">
              <div className="text-center space-y-4">
                ...
                <p className="text-[#183B4E]/80 text-base">
                  ...
                  will reopen{" "}
                  <span className="font-semibold text-[#DDA853]">Soon!</span>.
                </p>
          ...
          <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center px-4">
            <div className="bg-white max-w-2xl w-full rounded-xl shadow-2xl p-8 border border-[#F3F3E0] relative">
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-[#27548A]">
                  ...
                  <span className="font-semibold text-[#DDA853]">
                    {learningPrograms.find((p) => p.id === selectedProgram)?.title}
                  </span>
                </p>
              </div>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <label
                    className="block text-[#27548A] font-semibold mb-2"
                    htmlFor="fullName"
                  >
                    Full Name
                  </label>
                  <input
                    ...
                    type="text"
                    required
                    className="w-full px-4 py-3 border border-[#DDA853] focus:border-[#183B4E] focus:ring-[#183B4E]/20 focus:ring-2 outline-none transition shadow-sm rounded-lg"
                ...
                <div className="flex gap-4">
                  <Button
                    ...
                    variant="outline"
                    onClick={() => setSelectedProgram(null)}
                    className="flex-1 border-[#27548A] text-[#27548A] hover:bg-[#F3F3E0]"
                  >
                    Back
                  </Button>
                  <Button
                    type="submit"
                    className="flex-1 bg-[#27548A] text-[#F3F3E0] font-bold hover:bg-[#183B4E] transition-all duration-300"
                  >
                    {formSubmitted ? (
