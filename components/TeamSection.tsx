      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="mx-auto grid max-w-7xl gap-8 py-12 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 place-items-center">
          {teamMembers.map((member, index) => (
            <Card
              key={index}
              className="group bg-[#faf9f3] rounded-xl shadow-md hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 flex flex-col w-full max-w-sm border border-transparent hover:border-[#DDA853]/20"
            >
              <CardHeader className="text-center flex-1 flex flex-col">
                {/* Profile Image */}
                <div className="mx-auto mb-4">
                  <div className="w-[120px] h-[120px] mx-auto rounded-full overflow-hidden shadow-lg ring-4 ring-[#DDA853]/0 group-hover:ring-[#DDA853]/30 transition-all duration-300">
                    <Image
                      src={member.image}
                      width={120}
                      height={120}
                ...
                <div className="h-1 w-12 bg-[#DDA853] rounded mx-auto mb-3 group-hover:w-20 transition-all duration-300" />
                ...
                <div className="flex justify-center space-x-3 mt-auto pt-4 border-t border-gray-100">
                  <Link
                    ...
                    className="flex items-center justify-center w-10 h-10 rounded-full bg-[#E6ECF3] hover:bg-[#DDA853] hover:scale-110 hover:shadow-lg hover:shadow-[#DDA853]/25 transition-all duration-200"
                  >
