          ...
          <Link href="/software-solutions">
            <Card className="flex flex-col h-full items-center text-center border-0 shadow-lg hover:shadow-xl transition-shadow p-2">
              <CardHeader className="flex flex-col items-center">
                ...
                <CardTitle className="text-[#183B4E]">
                  Custom Development
                </CardTitle>
                <CardDescription className="text-[#183B4E]">
                  Dynamic platforms, custom websites, and mobile apps built with
          ...
          <Link href="/learn-With-Us">
            <Card className="flex flex-col h-full items-center text-center border-0 shadow-lg hover:shadow-xl transition-shadow p-2">
              <CardHeader className="flex flex-col items-center">
                ...
                <CardDescription className="text-[#183B4E]">
                  Comprehensive coding lessons and mentorship programs to help
                  students and junior developers grow.
                </CardDescription>
              </CardHeader>
            </Card>
          </Link>
          <Link href="/cctv-Installation">
            <Card className="flex flex-col h-full items-center text-center border-0 shadow-lg hover:shadow-xl transition-shadow p-2">
              <CardHeader className="flex flex-col items-center">
                ...
                <CardDescription className="text-[#183B4E]">
                  Professional installation services to secure your property
                  with high-quality surveillance cameras, ensuring safety and
                  peace of mind.
                </CardDescription>
              </CardHeader>
            </Card>
