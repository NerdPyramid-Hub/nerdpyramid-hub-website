        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-5 lg:col-span-1">
            ...
            <p className="text-sm text-[#F3F3E0]/55 leading-relaxed">
              We build software, train teams, and secure businesses with reliable CCTV solutions designed to help you grow.
            </p>
          ...
          <div className="space-y-5">
            ...
            <ul className="space-y-3.5">
              ...
              <li className="flex items-start gap-3 text-sm text-[#F3F3E0]/55">
                ...
                <a href="mailto:morosisakhe@gmail.com" className="hover:text-[#DDA853] transition-colors break-all">
